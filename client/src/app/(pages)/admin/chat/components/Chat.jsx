...
//                 className="w-64 bg-[#1a1b23] rounded-md py-2 px-4 pl-10 text-sm text-gray-300 focus:outline-none"
//               />
//             </div>
...
//               {[1, 2, 3, 4, 5].map((i) => (
//                 <div key={i} className="flex space-x-3 p-3 hover:bg-[#262731] rounded-md cursor-pointer">
...
//                 <div className="bg-[#1a1b23] rounded-lg p-4 max-w-md">
//                   <p className="text-gray-300">Hello John! Hope you're doing well. I need your help with some reports, are you available for a call later today?</p>
//                   <span className="text-gray-400 text-xs mt-2 block">10:40 AM</span>
//                 </div>
//               </div>
              
//               <div className="flex justify-end space-x-3">
//                 <div className="bg-purple-500 rounded-lg p-4 max-w-md">
